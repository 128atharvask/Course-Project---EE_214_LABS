...
-- state_out[0]	=>  Location: PIN_14,	 I/O Standard: 2.5 V,	 Current Strength: Default
...
SIGNAL \dut_instance|add_instance|ADD1|FA4|NAND8|Y~0_combout\ : std_logic;
SIGNAL \dut_instance|add_instance|ADD2|FA2|NAND4|Y~0_combout\ : std_logic;
SIGNAL \dut_instance|add_instance|OR3|Y~0_combout\ : std_logic;
SIGNAL \dut_instance|add_instance|OR3|Y~1_combout\ : std_logic;
SIGNAL \dut_instance|add_instance|ADD2|FA3|NAND4|Y~0_combout\ : std_logic;
SIGNAL \dut_instance|add_instance|ADD2|FA4|NAND8|Y~0_combout\ : std_logic;
SIGNAL \datau[4]~7_combout\ : std_logic;
SIGNAL \dut_instance|add_instance|OR1|Y~2_combout\ : std_logic;
SIGNAL \dut_instance|add_instance|ADD2|FA4|NAND5|Y~0_combout\ : std_logic;
...
SIGNAL \dut_instance|add_instance|OR1|Y~3_combout\ : std_logic;
...
-- pragma translate_on
PORT MAP (
	i => \dut_instance|add_instance|OR1|Y~3_combout\,
	devoe => ww_devoe,
	o => ww_state_out(0));
...
-- Equation(s):
-- \shift_reg~1_combout\ = (\u0|virtual_jtag_0|sld_virtual_jtag_basic_inst|virtual_state_cdr~0_combout\ & (\io~q\ & !\u0|virtual_jtag_0|sld_virtual_jtag_basic_inst|virtual_state_sdr~0_combout\))
...
-- Equation(s):
-- \dut_instance|add_instance|ADD1|FA2|NAND9|Y~0_combout\ = (dut_input(5) & ((dut_input(1)) # ((dut_input(0) & dut_input(4))))) # (!dut_input(5) & (dut_input(0) & (dut_input(4) & dut_input(1))))
...
-- Equation(s):
-- \dut_instance|add_instance|ADD1|FA3|NAND9|Y~0_combout\ = (dut_input(6) & ((dut_input(2)) # (\dut_instance|add_instance|ADD1|FA2|NAND9|Y~0_combout\))) # (!dut_input(6) & (dut_input(2) & \dut_instance|add_instance|ADD1|FA2|NAND9|Y~0_combout\))
...
PORT MAP (
	dataa => dut_input(6),
	datac => dut_input(2),
	datad => \dut_instance|add_instance|ADD1|FA2|NAND9|Y~0_combout\,
...
\dut_instance|add_instance|ADD1|FA4|NAND8|Y~0\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \dut_instance|add_instance|ADD1|FA4|NAND8|Y~0_combout\ = \dut_instance|add_instance|ADD1|FA3|NAND9|Y~0_combout\ $ (dut_input(7) $ (dut_input(3)))
...
-- pragma translate_on
PORT MAP (
	datab => \dut_instance|add_instance|ADD1|FA3|NAND9|Y~0_combout\,
	datac => dut_input(7),
	datad => dut_input(3),
	combout => \dut_instance|add_instance|ADD1|FA4|NAND8|Y~0_combout\);

-- Location: LCCOMB_X33_Y24_N28
\dut_instance|add_instance|ADD2|FA2|NAND4|Y~0\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \dut_instance|add_instance|ADD2|FA2|NAND4|Y~0_combout\ = dut_input(5) $ (dut_input(1) $ (((dut_input(0) & dut_input(4)))))
...
PORT MAP (
	...
	datac => dut_input(1),
	datad => dut_input(4),
	combout => \dut_instance|add_instance|ADD2|FA2|NAND4|Y~0_combout\);

-- Location: LCCOMB_X33_Y24_N22
\dut_instance|add_instance|OR3|Y~0\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \dut_instance|add_instance|OR3|Y~0_combout\ = (\dut_instance|add_instance|ADD2|FA2|NAND4|Y~0_combout\) # (\dut_instance|add_instance|ADD1|FA2|NAND9|Y~0_combout\ $ (dut_input(6) $ (dut_input(2))))
...
PORT MAP (
	...
	datab => \dut_instance|add_instance|ADD2|FA2|NAND4|Y~0_combout\,
	datac => dut_input(6),
	datad => dut_input(2),
	combout => \dut_instance|add_instance|OR3|Y~0_combout\);

-- Location: LCCOMB_X33_Y24_N2
\dut_instance|add_instance|OR3|Y~1\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \dut_instance|add_instance|OR3|Y~1_combout\ = (\dut_instance|add_instance|OR3|Y~0_combout\ & ((\dut_instance|add_instance|ADD1|FA3|NAND9|Y~0_combout\) # ((dut_input(3)) # (dut_input(7))))) # (!\dut_instance|add_instance|OR3|Y~0_combout\ & 
-- ((\dut_instance|add_instance|ADD1|FA3|NAND9|Y~0_combout\ & ((dut_input(3)) # (dut_input(7)))) # (!\dut_instance|add_instance|ADD1|FA3|NAND9|Y~0_combout\ & (dut_input(3) & dut_input(7)))))
...
-- pragma translate_on
PORT MAP (
	dataa => \dut_instance|add_instance|OR3|Y~0_combout\,
	datab => \dut_instance|add_instance|ADD1|FA3|NAND9|Y~0_combout\,
	datac => dut_input(3),
	datad => dut_input(7),
	combout => \dut_instance|add_instance|OR3|Y~1_combout\);

-- Location: LCCOMB_X33_Y24_N24
\dut_instance|add_instance|ADD2|FA3|NAND4|Y~0\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \dut_instance|add_instance|ADD2|FA3|NAND4|Y~0_combout\ = dut_input(2) $ (dut_input(6) $ (\dut_instance|add_instance|ADD1|FA2|NAND9|Y~0_combout\))
...
PORT MAP (
	...
	datac => dut_input(6),
	datad => \dut_instance|add_instance|ADD1|FA2|NAND9|Y~0_combout\,
	combout => \dut_instance|add_instance|ADD2|FA3|NAND4|Y~0_combout\);

-- Location: LCCOMB_X33_Y24_N30
\dut_instance|add_instance|ADD2|FA4|NAND8|Y~0\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \dut_instance|add_instance|ADD2|FA4|NAND8|Y~0_combout\ = \dut_instance|add_instance|ADD1|FA4|NAND8|Y~0_combout\ $ (((\dut_instance|add_instance|OR3|Y~1_combout\ & ((\dut_instance|add_instance|ADD2|FA2|NAND4|Y~0_combout\) # 
-- (\dut_instance|add_instance|ADD2|FA3|NAND4|Y~0_combout\)))))
...
-- pragma translate_on
PORT MAP (
	dataa => \dut_instance|add_instance|ADD1|FA4|NAND8|Y~0_combout\,
	datab => \dut_instance|add_instance|ADD2|FA2|NAND4|Y~0_combout\,
	datac => \dut_instance|add_instance|OR3|Y~1_combout\,
	datad => \dut_instance|add_instance|ADD2|FA3|NAND4|Y~0_combout\,
	combout => \dut_instance|add_instance|ADD2|FA4|NAND8|Y~0_combout\);

-- Location: LCCOMB_X33_Y25_N22
\datau[4]~7\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \datau[4]~7_combout\ = (\datau[3]~5_combout\ & (((\u0|virtual_jtag_0|sld_virtual_jtag_basic_inst|virtual_state_udr~0_combout\) # (!\u0|virtual_jtag_0|sld_virtual_jtag_basic_inst|virtual_state_sdr~0_combout\)) # (!\io~q\)))
...
\dut_instance|add_instance|OR1|Y~2\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \dut_instance|add_instance|OR1|Y~2_combout\ = (dut_input(3) & ((\dut_instance|add_instance|ADD1|FA3|NAND9|Y~0_combout\) # (dut_input(7)))) # (!dut_input(3) & (\dut_instance|add_instance|ADD1|FA3|NAND9|Y~0_combout\ & dut_input(7)))
...
PORT MAP (
	...
	datad => dut_input(7),
	combout => \dut_instance|add_instance|OR1|Y~2_combout\);

-- Location: LCCOMB_X33_Y24_N10
\dut_instance|add_instance|ADD2|FA4|NAND5|Y~0\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \dut_instance|add_instance|ADD2|FA4|NAND5|Y~0_combout\ = (\dut_instance|add_instance|ADD1|FA4|NAND8|Y~0_combout\ & (\dut_instance|add_instance|OR3|Y~1_combout\ & ((\dut_instance|add_instance|ADD2|FA2|NAND4|Y~0_combout\) # 
-- (\dut_instance|add_instance|ADD2|FA3|NAND4|Y~0_combout\))))
...
PORT MAP (
	...
	datac => \dut_instance|add_instance|OR3|Y~1_combout\,
	datad => \dut_instance|add_instance|ADD2|FA3|NAND4|Y~0_combout\,
	combout => \dut_instance|add_instance|ADD2|FA4|NAND5|Y~0_combout\);

-- Location: LCCOMB_X33_Y25_N26
\datau[4]~8\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \datau[4]~8_combout\ = (\datau[4]~7_combout\) # ((\shift_reg~1_combout\ & ((\dut_instance|add_instance|OR1|Y~2_combout\) # (\dut_instance|add_instance|ADD2|FA4|NAND5|Y~0_combout\))))
...
PORT MAP (
	...
	datab => \dut_instance|add_instance|OR1|Y~2_combout\,
	datac => \dut_instance|add_instance|ADD2|FA4|NAND5|Y~0_combout\,
...
-- Equation(s):
-- \datau[3]~6_combout\ = (\datau[3]~5_combout\) # ((\shift_reg~1_combout\ & \dut_instance|add_instance|ADD2|FA4|NAND8|Y~0_combout\))
...
PORT MAP (
	...
	datac => \dut_instance|add_instance|ADD2|FA4|NAND8|Y~0_combout\,
	datad => \datau[3]~5_combout\,
...
-- Equation(s):
-- \datau[2]~3_combout\ = (\shift_reg~1_combout\ & ((\dut_instance|add_instance|ADD2|FA2|NAND4|Y~0_combout\))) # (!\shift_reg~1_combout\ & (datau(3)))
...
PORT MAP (
	...
	datad => \dut_instance|add_instance|ADD2|FA2|NAND4|Y~0_combout\,
	combout => \datau[2]~3_combout\);

-- Location: LCCOMB_X33_Y24_N8
\datau[2]~4\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \datau[2]~4_combout\ = (\shift_reg~1_combout\ & (\dut_instance|add_instance|ADD2|FA3|NAND4|Y~0_combout\ $ (((!\datau[2]~3_combout\ & \dut_instance|add_instance|OR3|Y~1_combout\))))) # (!\shift_reg~1_combout\ & (\datau[2]~3_combout\))
...
-- Equation(s):
-- \datau[1]~2_combout\ = (\shift_reg~1_combout\ & ((\dut_instance|add_instance|OR3|Y~1_combout\ $ (\dut_instance|add_instance|ADD2|FA2|NAND4|Y~0_combout\)))) # (!\shift_reg~1_combout\ & (datau(2)))
...
-- Equation(s):
-- \datau[0]~0_combout\ = (\shift_reg~1_combout\ & ((dut_input(4) $ (dut_input(0))))) # (!\shift_reg~1_combout\ & (datau(1)))
...
\dut_instance|add_instance|OR1|Y~3\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \dut_instance|add_instance|OR1|Y~3_combout\ = (\dut_instance|add_instance|ADD2|FA4|NAND5|Y~0_combout\) # ((dut_input(3) & ((\dut_instance|add_instance|ADD1|FA3|NAND9|Y~0_combout\) # (dut_input(7)))) # (!dut_input(3) & 
-- (\dut_instance|add_instance|ADD1|FA3|NAND9|Y~0_combout\ & dut_input(7))))
...
PORT MAP (
	...
	datac => \dut_instance|add_instance|ADD2|FA4|NAND5|Y~0_combout\,
	datad => dut_input(7),
	combout => \dut_instance|add_instance|OR1|Y~3_combout\);
