...
-- Equation(s):
-- \add_instance|OR3|Y~0_combout\ = (\input_vector[2]~input_o\ & (\input_vector[0]~input_o\ & ((!\input_vector[1]~input_o\) # (!\input_vector[3]~input_o\)))) # (!\input_vector[2]~input_o\ & (\input_vector[1]~input_o\ & ((\input_vector[0]~input_o\) # 
