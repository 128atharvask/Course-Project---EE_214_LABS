...
SIGNAL \dut_instance|add_instance|dff1|Q~0_combout\ : std_logic;
SIGNAL \dut_input[1]~clkctrl_outclk\ : std_logic;
SIGNAL \dut_instance|add_instance|dff1|Q~q\ : std_logic;
SIGNAL \dut_instance|add_instance|dff2|Q~0_combout\ : std_logic;
...
-- Equation(s):
-- \datau[0]~1_combout\ = (\datau[0]~0_combout\ & (!\dut_instance|add_instance|dff0|Q~q\ & ((!\u0|virtual_jtag_0|sld_virtual_jtag_basic_inst|virtual_state_sdr~0_combout\)))) # (!\datau[0]~0_combout\ & (((datau(0)))))
...
-- pragma translate_on
PORT MAP (
	dataa => \dut_instance|add_instance|dff0|Q~q\,
...
\dut_instance|add_instance|dff1|Q~0\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \dut_instance|add_instance|dff1|Q~0_combout\ = !\dut_instance|add_instance|dff1|Q~q\
...
PORT MAP (
	...
	combout => \dut_instance|add_instance|dff1|Q~0_combout\);
...
PORT MAP (
	...
	d => \dut_instance|add_instance|dff1|Q~0_combout\,
...
\dut_instance|add_instance|dff2|Q~0\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \dut_instance|add_instance|dff2|Q~0_combout\ = (\dut_instance|add_instance|dff1|Q~q\ & (\dut_instance|add_instance|dff0|Q~q\)) # (!\dut_instance|add_instance|dff1|Q~q\ & ((\dut_instance|add_instance|dff2|Q~q\)))
...
PORT MAP (
	...
	combout => \dut_instance|add_instance|dff2|Q~0_combout\);
...
PORT MAP (
	clk => \dut_input[0]~clkctrl_outclk\,
	d => \dut_instance|add_instance|dff2|Q~0_combout\,
	clrn => \ALT_INV_dut_input[1]~clkctrl_outclk\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
